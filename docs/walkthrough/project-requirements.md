...
Squarkdown doesn’t care where your files are located – it will recursively scan for them, with rules configurable to suit your needs. You will, however, need to add `<!-- #SQUARK live! -->` headers to `.md` files you wish for Squarkdown to process.
